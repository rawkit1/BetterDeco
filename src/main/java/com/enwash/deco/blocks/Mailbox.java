...
public class Mailbox extends Block implements IHasModel {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(worldIn.isRemote) {
			playerIn.openGui(Main.instance, Reference.GUI_MAILBOX, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityMailbox tileentity = (TileEntityMailbox)worldIn.getTileEntity(pos);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) 
	{
		...
		if(stack.hasDisplayName()) {
			...
			if(tileentity instanceof TileEntityMailbox) {
				((TileEntityMailbox)tileentity).setCustomName(stack.getDisplayName());
			}
		}*/
